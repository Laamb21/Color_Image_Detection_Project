'''
JPG TIF Selection Script with Tkinter Front End
...
Allows users to adjust low and high gray thresholds via the GUI.
'''
...
def process_documents(input_dir_jpg, input_dir_tiff, log_file, progress_queue, low_threshold, high_threshold):
    """
...
class App:
    def __init__(self, root):
        ...
        self.select_button.grid(row=0, column=0, padx=(0,10), sticky='w')
